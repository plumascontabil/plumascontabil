...
{
    public class OfxBancosDomainService
    {
        ...
        public async Task<OfxBanco> Details(int? id)
        {
            try
            {
                var ofxBanco = await _ofxBancoRepository.GetById(id);
                return ofxBanco;
            }
            catch (Exception e)
            {
        ...
        public async Task<bool> CreateValidar(OfxBanco ofxBanco)
        {
            try
            {
                var adicionado = await _ofxBancoRepository.Adicionar(ofxBanco);
                return adicionado;
            }
            catch (Exception e)
            {
        ...
        public async Task<bool> EditValidar(OfxBanco ofxBanco)
        {
            try
            {
                var adicionado = await _ofxBancoRepository.Editar(ofxBanco);
                return adicionado;
            }
            catch (Exception e)
            {
        ...
        public async Task<bool> DeleteConfirmado(int id)
        {
            try
            {
                var deletado = await _ofxBancoRepository.Deletar(id);
                return deletado;
            }
            catch (Exception e)
            {
        ...
        private bool OfxBancoExists(int id)
        {
            try
            {
                var ofxBancoExist = _ofxBancoRepository.GetByIdExists(id);
                return ofxBancoExist;
            }
            catch (Exception e)
            {
                throw e.InnerException;
